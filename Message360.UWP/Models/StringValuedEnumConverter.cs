...
namespace message360.Models
{
    ...
    public class StringValuedEnumConverter : JsonConverter
    {
        ...
        {
            bool isNullableGeneric = enumType.IsConstructedGenericType && enumType.GetGenericTypeDefinition() == typeof(Nullable<>);
            ...
            Assembly assembly = typeof(StringValuedEnumConverter).GetTypeInfo().Assembly;
